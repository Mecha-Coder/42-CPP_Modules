...
- inside the base_class create a function. A derived_class inherit base_class and also create a function with the same name. So have 2 function implement at different class with the same name. Which one will the compiler select
...
========================
- based on the below example, it make sense of all instrument to make their respective sound. No need to implementaion in the based class (generic sound). We just need to make sure the derived class implement this.

in based class we write a constract that this function, the derived class have to implement
