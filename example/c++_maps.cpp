...
void debug() 
{
    std::cout << "This is debug function" << std::endl;
}

void info() 
{
    std::cout << "This is info function" << std::endl;
}

void warning() 
{
    std::cout << "This is warning function" << std::endl;
}

void error() 
{
    std::cout << "This is error function" << std::endl;
}
...
void complain(std::string issue)
{
    ...
    {
        // Key exists, call the associated function
        Action[issue]();
    }
    else
    {
