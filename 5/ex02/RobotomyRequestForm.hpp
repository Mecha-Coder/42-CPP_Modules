...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/01 15:59:29 by jpaul             #+#    #+#             */
/*   Updated: 2025/03/01 15:59:29 by jpaul            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    str filename = target +  "_shrubbery";
    if (getIsSigned() && executor.getGrade() <= getSignGrade())
    {
